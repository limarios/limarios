...
I am a Software Engineer and Full-Stack Developer with solid experience in developing web solutions, intelligent automation and complex integrations between systems. I work in all stages of the development cycle — from conception to delivery and maintenance — with a focus on performance, security and scalability.

--

Sou Engenheiro de Software e Desenvolvedor Full-Stack com sólida experiência no desenvolvimento de soluções web, automações inteligentes e integrações complexas entre sistemas. Atuo em todas as etapas do ciclo de desenvolvimento — da concepção à entrega e manutenção — com foco em performance, segurança e escalabilidade.
